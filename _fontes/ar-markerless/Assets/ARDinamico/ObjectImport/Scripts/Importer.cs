...
namespace ARDinamico.ObjectImport
{
    ...
    public class Importer : AssetViewerBase
    {
        /// <summary>
        ...
        private AssetLoaderContext assetLoaderContext;
        ...
        public void OnZoom(float value)
        {
            ...
            CameraDistance = Mathf.Min(CameraDistance - value * InputMultiplier, InputMultiplier * (1f / InputMultiplierRatio) * MaxCameraDistanceRatio);
        ...
        private void CopyFileForResources(string pathOrigin)
        {
            ...
            {
                string pathResources = $"{ Application.dataPath }/ARDinamico/Resources/3D/{ Path.GetFileName(pathOrigin) }";
        ...
        protected override void Start()
        {
            ...
            //{
            //    if (gameObject.scene.name == "ImporterScene")
            //    {
        ...
        //    if (RootGameObject != null)
        //    {
        //        markerIdObject.add(RootGameObject .name, id);
        //    }
        //}
        ...
        private void ProcessInputInternal(Transform cameraTransform)
        {
            if (!EventSystem.current.IsPointerOverGameObject())
            {
                if (Input.touchCount > 0)
                {
                    ...
                    {
                        CameraPivot -= cameraTransform.up * Input.touches[0].deltaPosition.y * 0.01f * Time.deltaTime + cameraTransform.right * Input.touches[0].deltaPosition.x * 0.01f * Time.deltaTime;
                    }
        ...
        protected override void OnLoad(AssetLoaderContext assetLoaderContext)
        {
            ...
            this.assetLoaderContext = assetLoaderContext;
