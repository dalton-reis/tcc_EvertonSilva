...
//              Debug.Log ("matches " + matches.ToString ());
            ...
            int minNumberMatchesAllowed = PropertiesModel.AmountPointMinimum;
...
//              Debug.Log ("dstPoints " + dstPoints.ToString ());
                ...
                Calib3d.findHomography (srcPoints, 
                    ...
                    inliersMask, 2000, 0.555).copyTo (homography);
        ...
        public void SaveImage(Mat imageSave)
        {
            Imgcodecs.imwrite(GetImagePath(), imageSave);
        }
    }
}